export default function BusDetailsCard({
  ...
  pricePerSeat = 550,
  boardingPoint = "Laxmipur",
  droppingPoint = "Bogura",
  estHours = 11,
}) {
  return (
    <div className="bg-gray-50 rounded-xl p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-black">{operator}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
        <div>
          ...
          <p className="font-semibold text-black">{route}</p>
        </div>
        <div>
          <span className="text-gray-600">Departure Time</span>
          <p className="font-semibold text-black">{departureTime}</p>
        </div>
        <div className="md:col-span-2 flex gap-2 sm:gap-4 flex-wrap">
          ...
          <div className="bg-gray-200 px-3 py-1 rounded text-xs">
            Est. Time - {estHours} Hour{estHours === 1 ? "" : "s"}
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end mt-4">
        <div className="text-right">
          ...
          <div className="text-2xl font-bold text-black">BDT {pricePerSeat}</div>
